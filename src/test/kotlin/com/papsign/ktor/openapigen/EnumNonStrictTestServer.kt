...
class NonStrictEnumTestServer {
    ...
    @Test
    fun `nullable enum parsing should be case-sensitive and should return 200 with null result`() = testApplication {
        application {
            nullableEnum()
        }
    ...
    @Test
    fun `nullable enum parsing should return 200 with null result on parse values outside of enum`() = testApplication {
        application {
            nullableEnum()
        }
