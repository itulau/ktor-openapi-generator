...
import com.papsign.ktor.openapigen.getMapKeyContentType
import com.papsign.ktor.openapigen.getMapValueContentType
...
object DefaultMapSchemaProvider : SchemaBuilderProviderModule, OpenAPIGenModuleExtension, DefaultOpenAPIModule {
    ...
    private object Builder : SchemaBuilder {
        ...
        override fun build(
            ...
            checkType(type)
            if (type.getMapKeyContentType() != getKType<String>())
                error("bad type $type: Only maps with string keys are supported")
            val valueType = type.getMapValueContentType()
